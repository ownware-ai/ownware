...
export const PCC04_PUBLIC_OPERATIONS: readonly Pcc04PublicOperationOwner[] = [
  { operationId: 'capabilities', capabilityId: 'gateway.capabilities', capabilityVersion: 23, sdkMethod: 'capabilities', journey: 'prerequisite', proofId: 'client.source-capability-negotiation' },
