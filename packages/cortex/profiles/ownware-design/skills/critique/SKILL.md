...
4. **Apply the fixes surgically.** Edit the right `data-cx-id` region, or the right CSS rule, or the right token. No wholesale rewrites unless craft is ≤ 2 across the board.
