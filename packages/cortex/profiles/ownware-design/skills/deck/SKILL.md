...
<body>
  <div class="deck-wrap">
    <div class="deck-stage" id="deck-stage">
      <section class="slide active" data-screen-label="01 Cover" data-cx-id="slide-1-cover">…</section>
      <section class="slide"        data-screen-label="02 Problem" data-cx-id="slide-2-problem">…</section>
      <section class="slide"        data-screen-label="03 Market" data-cx-id="slide-3-market">…</section>
      <!-- … remaining slides … -->
    </div>
  </div>
...
Each slide has its own `data-cx-id` for surgical edits. Inside a slide:
...
This is how the user references slides: "make slide 7 use a stepped chart instead of polyline." You find `data-screen-label="07 …"` (or `data-cx-id="slide-7-…"`), edit between its tags, leave everything else.
