  ...
  it('declares only the deliberately published v1 operations', async () => {
    ...
    await expect(response.json()).resolves.toEqual({
      ...
      capabilities: [
        ...
        { id: 'profiles.deployment.state.read', version: 1 },
        { id: 'profiles.list', version: 1 },
        { id: 'profiles.pause', version: 1 },
        { id: 'profiles.resume', version: 1 },
        { id: 'credentials.read', version: 1 },
        { id: 'memories.manage', version: 1 },
        { id: 'memories.read', version: 1 },
        { id: 'profiles.undeploy', version: 1 },
        ...
        { id: 'activity.read', version: 1 },
        { id: 'approvals.decide', version: 1 },
        { id: 'approvals.read', version: 1 },
        ...
        { id: 'runs.job-receipt.read', version: 1 },
        ...
        { id: 'skills.manage', version: 1 },
        { id: 'skills.read', version: 1 },
        { id: 'schedules.manage', version: 1 },
        { id: 'schedules.read', version: 1 },
        { id: 'runtimes.codex.login', version: 1 },
        { id: 'runtimes.codex.logout', version: 1 },
        { id: 'runtimes.codex.models', version: 1 },
        { id: 'runtimes.codex.read', version: 1 },
        ...
        { id: 'user_identity.manage', version: 1 },
        { id: 'user_identity.read', version: 1 },
        { id: 'threads.hydrate', version: 1 },
        { id: 'workspaces.manage', version: 1 },
        { id: 'workspaces.read', version: 1 },
        { id: 'threads.list', version: 1 },
      ],
      limits: {
        ...
        sensitiveInput: {
          interactionCapability: 'sensitive-input.v1',
