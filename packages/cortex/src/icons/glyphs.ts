/**
 * Profile glyph registry — SVG path strings from Lucide (MIT licensed).
 *
 * Each glyph is the INNER <path>/<circle> markup for a 24×24 viewBox,
 * stroke="currentColor" stroke-width="2" fill="none" linecap="round" linejoin="round".
 *
 * Usage:
...
export const GLYPHS = {
  ...
  'file-check': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="m9 15 2 2 4-4"/>',
  ...
  'file-search': '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><circle cx="11.5" cy="14.5" r="2.5"/><path d="M13.25 16.25 15 18"/>',
