 ...
 * `tier: 'legacy'` once a successor exists. Provider Hub supplies active model
 * facts and its pricebook; this file supplies only editorial policy and the
 * OpenRouter slug used to join that authority.
 */
