...
- `packages/runtime/src/gateway/handlers/tools.ts` — backend source; check whether the field exists.

## Plan
1. **Confirm backend returns the field** — `packages/runtime/src/gateway/handlers/tools.ts`
