...
} from '../helpers/manifest.schema.js'
...
## Inputs
- \`category\` (optional): one of starter | editorial | minimal | consumer | tech | experimental | fintech | data.
  ...
  inputSchema: {
    ...
    properties: {
      category: {
        ...
        description: 'Filter to one category. Omit to search across every category.',
      },
      surface: {
        type: 'string',
