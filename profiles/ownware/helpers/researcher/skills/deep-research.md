...
Write the question down as **3–6 concrete sub-questions**. You are "done" only when each is answered or explicitly marked unanswerable. Example — "research current household-battery disposal guidance for my council area" becomes:
- What does the council's primary guidance require?
- What does the state environmental authority require?
- Which drop-off locations are currently listed?
- Which details vary by battery type or change over time?
